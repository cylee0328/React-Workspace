...
//로트 노드
//리액트로 구현한 애플리케이션은 일반적으로 하나의 루트 DOM노드가 존재하며,
...
root.render(
  /*
    ...
    App이라는 컴포넌트를 사용하기 위해서는 상단에 import문으로 App이 추가되어 있어야함

    리액트에서 컴포넌트가 대문자로 시작하는 이유는, 리액트에서 소문자는 html dom요소(div, p, h2)로 해것을 하고
